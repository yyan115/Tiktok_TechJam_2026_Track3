...
Updated: 2026-08-28 ~12:00 (v1.0.2 freeze candidate, review round 5 pending)
...
- Freeze-candidate commits: 7ad64de (v1.0.2 fixes) + 81e077b (hash record) + the round-5 fix commit on top; the checklist bottom line names the current frozen commit. Codex round 6 pending.
