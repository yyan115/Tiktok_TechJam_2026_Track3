...
__global__ __launch_bounds__(WARPS * WARP) void nq_kernel(
  ...
  const int n0 = warp * 16;                     // this warp's column band
...
void nq_launch(int cfg, torch::Tensor X, torch::Tensor W, torch::Tensor Bias,
  ...
  switch (cfg) {
    case 0: go(32,  8, nq_kernel<32, 8>);  break;
    case 1: go(64,  8, nq_kernel<64, 8>);  break;
    case 2: go(128, 8, nq_kernel<128, 8>); break;
    case 3: go(64,  4, nq_kernel<64, 4>);  break;
    case 4: go(128, 4, nq_kernel<128, 4>); break;
    default: go(64, 8, nq_kernel<64, 8>);  break;
  }
}

int64_t nq_num_configs() { return 5; }
"""
